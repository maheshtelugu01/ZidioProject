...
public class ApplicationController {
	...
	public ResponseEntity<String> deactivateJobApplication(@PathVariable Long id) {
		return ResponseEntity.ok(applicationService.deactivateJobApplication(id));
	}

	@PutMapping("/internship/{id}/deactivate")
	public ResponseEntity<String> deactivateInternshipApplication(@PathVariable Long id) {
		return ResponseEntity.ok(applicationService.deactivateInternshipApplication(id));
	}
